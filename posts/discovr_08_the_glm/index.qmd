...
```{r}
broom::glance(album_lm) |> knitr::kable(digits = 3)
```
...
- $X$ ($b_1$) is 0.096. - represents the change in outcome associated with a unit change in predictor.
  - when the predictor increases by 1, the outcome increases by .096, but since the units of measurement was thousands of pounds and thousands of sales, an increase in $1000 will lead to 96 more albumes sold
